...
public class CursedHeartCrystal extends StatBoosterItem {
    public CursedHeartCrystal(Properties properties) {
        super(properties);
    }
    ...
    protected void increaseStat(Player player) {
        SHPlayers.getPlayerData(player).subHeartCrystals(player, SHItems.heartCrystalIncreaseAmount());
    }
